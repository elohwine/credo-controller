...
export default function Catalog() {
    ...
    return (
        <Layout>
            <Head>
                <title>Unified Catalog - Credo Portal</title>
            </Head>
            <div className="p-8">
                <div className="flex justify-between items-start mb-8">
                    ...
                    {trustCard && (
                        <div className={`bg-white p-4 rounded-lg shadow-md border-l-4 ${trustCard.badge === 'gold' ? 'border-yellow-400' :
                                trustCard.badge === 'silver' ? 'border-gray-400' :
                                    trustCard.badge === 'bronze' ? 'border-orange-600' : 'border-blue-400'
                            }`}>
                            <div className="flex items-center gap-3">
                                <div className="text-2xl font-bold">{trustCard.score}</div>
                                <div className="text-sm font-semibold uppercase tracking-wider text-gray-500">{trustCard.badge} Merchant</div>
                            </div>
                            <div className="mt-3 space-y-1">
                                {trustCard.topDrivers.map((d, i) => (
                                    <div key={i} className="flex justify-between text-xs gap-4">
                                        <span className="text-gray-600 flex gap-1 items-center">{d.icon} {d.name}</span>
